...
public class PantallaListarMatrimonios extends javax.swing.JInternalFrame {
    ControladorMatrimonio controladorMatrimonio;
    public PantallaListarMatrimonios(ControladorMatrimonio controladorMatrimonio) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       List<Matrimonio> p=controladorMatrimonio.getLista();
