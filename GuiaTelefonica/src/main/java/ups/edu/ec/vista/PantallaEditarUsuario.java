...
public class PantallaEditarUsuario extends javax.swing.JInternalFrame {
ControladorPersona controladorPersona;
int id;
    
    public PantallaEditarUsuario(ControladorPersona controladorPersona, int id) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String aperllido=jTextField2.getText();
      String contrasena=jTextField3.getText();
      
      Persona p=new Persona(id, nombre, aperllido, contrasena);
        
      boolean cent=controladorPersona.actualizar(p);
        if(cent==true){
