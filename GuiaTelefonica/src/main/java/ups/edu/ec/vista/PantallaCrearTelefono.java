...
public class PantallaCrearTelefono extends javax.swing.JInternalFrame {

    ControladorTelefono controladorTelefono;
    ControladorPersona controladorPersona;
    int idper;
    public PantallaCrearTelefono(ControladorTelefono controladorTelefono, ControladorPersona controladorPersona, int id) {
        initComponents();
